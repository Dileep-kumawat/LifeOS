...
- **Frontend Web (`/web`)**: React 18 + Vite, TypeScript, Tailwind CSS, Zustand, TanStack Query, React Router v6, Google Sign-In button (`GoogleSignInButton`), Connected Accounts management in Settings, Web Speech API + Web Audio API inline Voice Input (`useWebVoiceInput`, `VoiceWaveform`), PrivacyPolicyModal, Storybook (50+ stories), Sentry.
...
# Database Backup & Disaster Recovery (NFR-3.3)
