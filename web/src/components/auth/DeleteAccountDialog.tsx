  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <div className="flex flex-col gap-3 py-2 text-sm text-[#31302e]">
        <p>
          Your account will be <strong>soft-deleted immediately</strong> and you will be signed out
          of all active devices.
        </p>
        <p className="bg-red-50 p-3 rounded-lg border border-red-100 text-xs text-red-800">
          <strong>Important:</strong> All calendar events, goals, habits, and notes will be
          permanently purged after a <strong>30-day grace period</strong>.
        </p>
      </div>
