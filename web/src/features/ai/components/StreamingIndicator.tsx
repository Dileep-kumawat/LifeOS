...
export const StreamingIndicator: React.FC<StreamingIndicatorProps> = ({
  ...
  return (
    <div className="flex flex-col gap-2 py-2 px-4 max-w-3xl mx-auto w-full">
      {backupModelStatus && (
        <div className="inline-flex items-center gap-2 text-xs font-medium text-amber-700 bg-amber-50 border border-amber-200 px-3.5 py-2 rounded-md w-fit animate-pulse">
      ...
      {isStreaming && (
        <div className="inline-flex items-center gap-2 text-xs font-medium text-[#615d59] bg-[#f6f5f4] border border-[#e6e6e6] px-3.5 py-2 rounded-full w-fit">
