...
const variantStyles = {
  blue: {
    ...
    iconBg:
      "bg-blue-500/10 text-blue-600 dark:bg-blue-500/15 dark:text-blue-400 border border-blue-500/20 shadow-xs shadow-blue-500/10",
    badge:
      "bg-white/90 text-blue-600 border border-blue-200/80 shadow-2xs group-hover:bg-blue-50 group-hover:border-blue-300 group-hover:text-blue-700 dark:bg-slate-900/90 dark:text-blue-300 dark:border-blue-800/80 dark:group-hover:bg-blue-950/60",
  ...
  emerald: {
    ...
    iconBg:
      "bg-emerald-500/10 text-emerald-600 dark:bg-emerald-500/15 dark:text-emerald-400 border border-emerald-500/20 shadow-xs shadow-emerald-500/10",
    badge:
      "bg-white/90 text-emerald-600 border border-emerald-200/80 shadow-2xs group-hover:bg-emerald-50 group-hover:border-emerald-300 group-hover:text-emerald-700 dark:bg-slate-900/90 dark:text-emerald-300 dark:border-emerald-800/80 dark:group-hover:bg-emerald-950/60",
  ...
  amber: {
    ...
    iconBg:
      "bg-amber-500/10 text-amber-600 dark:bg-amber-500/15 dark:text-amber-400 border border-amber-500/20 shadow-xs shadow-amber-500/10",
    badge:
      "bg-white/90 text-amber-600 border border-amber-200/80 shadow-2xs group-hover:bg-amber-50 group-hover:border-amber-300 group-hover:text-amber-700 dark:bg-slate-900/90 dark:text-amber-300 dark:border-amber-800/80 dark:group-hover:bg-amber-950/60",
  ...
  purple: {
    ...
    iconBg:
      "bg-purple-500/10 text-purple-600 dark:bg-purple-500/15 dark:text-purple-400 border border-purple-500/20 shadow-xs shadow-purple-500/10",
    badge:
      "bg-white/90 text-purple-600 border border-purple-200/80 shadow-2xs group-hover:bg-purple-50 group-hover:border-purple-300 group-hover:text-purple-700 dark:bg-slate-900/90 dark:text-purple-300 dark:border-purple-800/80 dark:group-hover:bg-purple-950/60",
  ...
  rose: {
    ...
    iconBg:
      "bg-rose-500/10 text-rose-600 dark:bg-rose-500/15 dark:text-rose-400 border border-rose-500/20 shadow-xs shadow-rose-500/10",
    badge:
      "bg-white/90 text-rose-600 border border-rose-200/80 shadow-2xs group-hover:bg-rose-50 group-hover:border-rose-300 group-hover:text-rose-700 dark:bg-slate-900/90 dark:text-rose-300 dark:border-rose-800/80 dark:group-hover:bg-rose-950/60",
...
export function StatCard({
      ...
      <div className="flex flex-col min-w-0 flex-1">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-1.5 min-w-0">
            {Icon && (
              <Icon className="size-3.5 text-muted-foreground shrink-0 transition-transform duration-200 group-hover:scale-110" />
            )}
        ...
        <div className="flex items-baseline gap-2 mt-0.5">
          ...
          {subtitle && (
            <span className="text-xs font-normal text-muted-foreground truncate">{subtitle}</span>
          )}
          {trend && (
            <span
              className={cn(
  ...
  if (href) {
    return (
      <Link
        to={href}
        className="block outline-hidden focus-visible:ring-2 focus-visible:ring-primary rounded-xl"
      >
        {content}
      </Link>
    );
