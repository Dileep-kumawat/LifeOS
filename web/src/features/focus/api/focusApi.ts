...
export const focusApi = {
  ...
  /**
   * Abandon focus session early (partial focus time preserved)
   */
  ...
  /**
   * Trigger client-timed interval transition (work -> break or break -> work)
   */
  ...
  /**
   * List historical focus sessions with optional filters
   */
