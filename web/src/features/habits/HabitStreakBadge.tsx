...
export function HabitStreakBadge({
  ...
  if (currentStreak === 0) {
    return (
      ...
      >
        <Flame
          className="size-3.5 text-[#a39e98] transition-transform duration-200 group-hover:scale-115"
  ...
  if (isPersonalBest) {
    return (
      ...
      >
        <Trophy
          className="size-3.5 text-purple-600 transition-transform duration-200 group-hover:scale-120 group-hover:rotate-12"
          data-icon="inline-start"
        />
        <span>
          {currentStreak}
  ...
  if (isAtRisk) {
    return (
      ...
      >
        <AlertCircle
          className="size-3.5 text-amber-600 transition-transform duration-200 group-hover:scale-115"
          data-icon="inline-start"
        />
        <span>
          {currentStreak}
  ...
  return (
    ...
    >
      <Flame
        className="size-3.5 text-orange-500 fill-orange-500 transition-transform duration-200 group-hover:scale-125 group-hover:animate-flame-wobble"
        data-icon="inline-start"
      />
      <span>
        {currentStreak}
